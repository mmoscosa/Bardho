<template lang="html">
  <div class="">
    ...
    <p>We collect information from you when you subscribe to a newsletter, Use Live Chat or enter information on our site.</p>
    ...
    <nuxt-link to="/disclaimers?section=cookies">More info</nuxt-link>
    ...
    <h3>If at any time you would like to unsubscribe from receiving future emails, you can email us atp</h3>
    ...
    <nuxt-link to="/contact">https://www.bardho.com/contact</nuxt-link>
